    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-3 py-6 sm:px-4">
        <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900 p-4 text-center sm:p-6">
          ...
          <p className="mt-2 text-sm text-zinc-400">We sent a password reset link to <span className="break-all text-white">{email}</span>.</p>
          <Link href="/login" className="mt-4 inline-block text-sm text-emerald-400 hover:text-emerald-300">Back to login</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 shadow-2xl sm:p-6">
          ...
          <div className="mt-4 text-center text-sm">
            <Link href="/login" className="text-zinc-500 hover:text-zinc-300 transition-colors">Back to login</Link>
          </div>
        </div>
      </div>
    </div>

      ...
      <div className="relative mx-auto flex min-h-full max-w-6xl flex-col px-3 py-6 sm:px-6 sm:py-12 md:px-8">
        <header className="flex flex-col gap-4 sm:gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:gap-3">
            <Link href="/wallets" className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-zinc-700 bg-zinc-800/50 px-3 py-2.5 text-sm font-medium text-zinc-300 transition-colors hover:border-zinc-600 hover:bg-zinc-800 hover:text-white min-[400px]:flex-none min-[400px]:px-4">
              <WalletIcon />
              Wallets
            </Link>
            <button
